...
Promotion of Standards Track LIPs into the core LLMO specification is a separate governance action that occurs as part of a specification version bump (for example, v0.1 to v0.2). The mechanism for such promotion will be defined in a future Process LIP.
