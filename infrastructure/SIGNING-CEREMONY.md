...
- **v4 (2026-05-01)** (`~/llmo-key-ceremony-2026-05-01/`): out-of-cadence ceremony driven by v0.1.5 spec changes. `document_id="2026-q2-revision-2"`, `valid_from="2026-05-01"`, `valid_until="2026-07-26"` (preserves v3 cadence). `disavowal-affiliations` claim gains a per-claim signature, demonstrating the new X6 strict-tier rule end-to-end against the live document. Same key as v1-v3 (no rotation). Canonical payload sizes: 2032 bytes (document-level), 442 bytes (disavowal claim per-claim signature).
