...
<Info>
Without validation, a truth pack is just another JSON file. With validation, it is a verifiable artifact.
</Info>

Validation is how the LLMO protocol distinguishes truth from noise.
