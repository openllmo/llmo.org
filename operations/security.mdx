...
title: "Security"
icon: "lock"
description: "Threat model, provenance protection, tamper resistance, and integrity requirements for LLMO systems."
---

# Security

This section specifies the threat model and security requirements for LLMO systems. Security protects truth integrity against adversarial, accidental, and entropic degradation.
...
A single compromised authoritative source can propagate false claims across every model that retrieves from it. Attack vectors include:
...
If the audit layer is compromised, the system loses the ability to verify its own history. All other protections become unenforceable. Attack vectors include:
