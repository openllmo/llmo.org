...
<Warning>
Source poisoning is the highest-impact threat in LLMO systems. A single compromised authoritative source can propagate false claims across every model that retrieves from it.
</Warning>
...
<Warning>
If the audit layer is compromised, the system cannot verify its own history. Every other protection becomes unenforceable.
</Warning>
