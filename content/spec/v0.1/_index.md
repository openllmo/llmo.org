...
The changelog for the v0.1 specification series is maintained at [`/spec/changelog/`](/spec/changelog/). That document is the single source of truth for version history and patch revisions.
