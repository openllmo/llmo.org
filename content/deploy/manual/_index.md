---
title: "Deploy LLMO (manual CLI walkthrough)"
linkTitle: "Manual"
description: "Drive each step of LLMO publishing by hand via the llmo CLI."
date: 2026-04-29
weight: 1
---

The full `llmo` CLI flow, step-by-step. Use this if you're automating in CI, hosting on a platform not covered by a guided path, or you want to understand every step before delegating.

For most publishers, the [Claude Code wizard](/deploy/#claude-code-live) is the faster path.
