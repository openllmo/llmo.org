...
- **Standards Track**: proposes a new extension claim type or a modification to an existing claim type. Authors must demonstrate control of a DNS namespace at submission (see Section 4). The terminal accepted state for a Standards Track LIP is Final.
...
Standards Track LIPs propose extensions to the claim registry. The submission process has eight steps:
...
- **Standards Track**: the LIP type proposing a new extension claim type, or a modification to an existing claim type.
