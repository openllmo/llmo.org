...
<Warning>
A model that surfaces your entity but associates it with stale, conflicting, or fabricated claims is worse than a model that does not mention you at all.
</Warning>
...
<Info>
See [llmo.json](/protocol/llmo-json) for the full schema, field reference, and a working example truth pack.
</Info>
